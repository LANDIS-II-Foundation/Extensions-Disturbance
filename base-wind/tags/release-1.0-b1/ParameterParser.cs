		...
		: Landis.TextParser<IParameters>
	{
		...
		protected override IParameters Parse()
		{
			...
			while (! AtEndOfInput && CurrentName != WindSeverities) {
				...
				IEditableEventParameters eventParms = new EditableEventParameters();
			...
			while (! AtEndOfInput && CurrentName != MapNames
				...
				IEditableSeverity severity = new EditableSeverity();
