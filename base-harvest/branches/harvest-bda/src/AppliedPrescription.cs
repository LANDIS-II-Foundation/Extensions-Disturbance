...
namespace Landis.Extension.BaseHarvest
{
    ...
    public class AppliedPrescription
    {
        ...
        /// <summary>
        /// The number of stands remaining to be harvested by this prescription
        /// during the current timestep.
        /// </summary>
        public double StandsRemainingToHarvest
        {
            get
            {
                return standsRemainingToHarvest;
            }
        }
        ...
        public void InitializeForHarvest(List<Stand> stands)
        {
            ...
            //if (isDebugEnabled) {
            //PlugIn.ModelCore.Log.WriteLine("prescription {0}:", prescription.Name);
            //PlugIn.ModelCore.Log.WriteLine("  _Ranking_  Stand");
                //foreach (StandRanking ranking in rankings)
                    //PlugIn.ModelCore.Log.WriteLine("  {0,9}  {1,5}", ranking.Rank, ranking.Stand.MapCode);
            //}
