...
namespace Landis.Harvest
{
        ...
        : StandSpreading, ISiteSelector, IEnumerable<ActiveSite>
    {
        ...
        IEnumerator<ActiveSite> IEnumerable<ActiveSite>.GetEnumerator() {
            ...
            //random = (int) (Landis.Util.Random.GenerateUniform() * 
            //    (stand.SiteCount - 1));
            ...
            //while (sites.Count > 0) {
            //    //UI.WriteLine("   ERROR:  Non-active site included in stand {0}.", stand.MapCode);
            ...
            while (areaSelected < standTargetArea && sites.Count > 0) 
            {
                ...
                //UI.WriteLine("Done with a patch.");
                ...
                patchAreaSelected = 0;
                //UI.WriteLine("areaSelected = {0}", areaSelected);
            } // while (areaSelected < standTargetArea && sites.Count > 0)
            ...
            if (areaSelected >= standTargetArea) {
                ...
                //UI.WriteLine("Rejecting stand {0} for prescription {1}",stand.MapCode, stand.PrescriptionName);
