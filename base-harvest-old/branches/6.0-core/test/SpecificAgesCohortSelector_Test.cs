...
namespace Landis.Test.Harvest
{
    ...
    public class SpecificAgesCohortSelector_Test
    {
        ...
        {
            return TestUtil.AgeCohorts.SpeciesCohorts.Create(abiebals, ages);
        }
        ...
        {
            Assert.IsTrue(TestUtil.AgeCohorts.SpeciesCohortBoolArray.Equals(isHarvested, expectedValues));
        }
