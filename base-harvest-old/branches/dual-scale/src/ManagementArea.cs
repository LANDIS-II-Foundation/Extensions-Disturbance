...
namespace Landis.Harvest
{
    ...
    public class ManagementArea
    {
        ...
        public void HarvestStands()
        {
            ...
            UI.WriteLine("      Stands re-initialized (harvested = false)");
...
/*                         foreach (StandRanking sr in prescription.Rankings) {
            ...
            while (activePrescriptions.Count > 0) {
                ...
                //UI.WriteLine("    Number active prescriptions = {0}. ratioTotal={1}", activePrescriptions.Count, ratioTotal);
...
/*                  UI.WriteLine("area remaining for {0} = {1}", selectedPrescription.Prescription.Name,
                    ...
                    //UI.WriteLine("    Harvesting stand = {0}.", stand.MapCode);
            ...
            UI.WriteLine("    Completed Management Area.");
