...
namespace Landis.Harvest
{
        ...
        : Landis.TextParser<IParameters>
    {
        ...
        {
            UI.WriteLine("   Begin parsing harvest input file...");
        ...
        protected void ReadPrescriptions(List<Prescription> prescriptions,
                                         int                harvestTimestep)
        {
            UI.WriteLine("   Begin reading harvest prescriptions...");
        ...
        //3. form rankingMethod and return it.
            ...
            UI.WriteLine("   Begin reading stand ranking data...");
        ...
        protected void ReadForestTypeTable() 
        {
            ...
            UI.WriteLine("   Begin reading forest type table...");
            speciesLineNumbers.Clear();  // in case parser re-used
                                                             ...
                                                             out int      index)
        {
            ...
            //  Site selection -- Patch cutting
                ...
                InputVar<int> size = new InputVar<int>("the target patch size");
        ...
        {
            UI.WriteLine("   Begin reading harvest implementation table...");
