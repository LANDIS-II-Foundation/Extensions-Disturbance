...
using Wisc.Flel.GeospatialModeling.Landscapes.DualScale; //added to use ActiveSite in ComputeRank method
        ...
        {            
            ...
            foreach (Stand stand in stands) {
                ...
                if (!assigned) {
                    ...
                    freq_array[j] = 1;
                    //UI.WriteLine("not assigned.  element {0} gets {1}", j, stand.Age);
                }
            }
