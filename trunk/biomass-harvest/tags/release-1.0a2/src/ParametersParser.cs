...
namespace Landis.Extensions.BiomassHarvest
{
        ...
        : BaseHarvest.ParametersParser
    {
        ...
        private double standSpreadTargetSize;
        ...
        protected ISiteSelector WrapSiteSelector(ISiteSelector siteSelector)
        {
            if (siteSelector is BaseHarvest.CompleteStandSpreading)
                return new CompleteStandSpreading(standSpreadTargetSize);
            else if (siteSelector is BaseHarvest.PartialStandSpreading)
                return new PartialStandSpreading(standSpreadTargetSize);
            else
        ...
        protected override BaseHarvest.IParameters Parse()
        {
            ...
            BaseHarvest.EditableParameters parameters = new BaseHarvest.EditableParameters();
